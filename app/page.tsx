  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[80vh] text-center max-w-4xl mx-auto">
      ...
      >
        ...
        <div className="relative w-48 h-48 md:w-64 md:h-64 rounded-full overflow-hidden border-4 border-white shadow-2xl shadow-slate-200/50">
          <Image src="/images/profile.png" alt="Keertan Vijay" fill className="object-cover" style={{ objectPosition: 'center 5%' }} priority />
        </div>
      </motion.div>
